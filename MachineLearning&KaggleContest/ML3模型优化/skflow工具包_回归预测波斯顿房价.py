...
print( '------------随机森林回归模型------------' )
print( 'The mean-absolute-error of RandomForestRegressor on boston datasets is:',
       metrics.mean_absolute_error( rfr_y_predict, y_test ) )
print( 'The mean-squared-error of RandomForestRegressor on boston datasets is:',
       metrics.mean_squared_error( rfr_y_predict, y_test ) )
print( 'The R-squared of RandomForestRegressor on boston datasets is:',
