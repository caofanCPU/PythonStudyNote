...
print( 'R-squared value of linear-SVR is:',
       linear_svr.score( s_X_test, s_y_test ) )
print( 'MSE value of linear-SVR is:',
       mean_squared_error( ss_y.inverse_transform( s_y_test ),
                           ss_y.inverse_transform( linear_svr_y_predict ) ) )
print( 'MAE value of linear-SVR is:',
       mean_absolute_error( ss_y.inverse_transform( s_y_test ),
                           ss_y.inverse_transform( linear_svr_y_predict ) ) )

print( '----多项式核函数SVR-----' )
print( 'R-squared value of poly-SVR is:',
       poly_svr.score( s_X_test, s_y_test ) )
print( 'MSE value of poly-SVR is:',
       mean_squared_error( ss_y.inverse_transform( s_y_test ),
                           ss_y.inverse_transform( poly_svr_y_predict ) ) )
print( 'MAE value of poly-SVR is:',
       mean_absolute_error( ss_y.inverse_transform( s_y_test ),
                            ss_y.inverse_transform( poly_svr_y_predict ) ) )

print( '----径向基核函数SVR-----' )
print( 'R-squared value of rbf-SVR is:',
       rbf_svr.score( s_X_test, s_y_test ) )
print( 'MSE value of rbf-SVR is:',
       mean_squared_error( ss_y.inverse_transform( s_y_test ),
                           ss_y.inverse_transform( rbf_svr_y_predict ) ) )
print( 'MAE value of rbf-SVR is:',
       mean_absolute_error( ss_y.inverse_transform( s_y_test ),
                            ss_y.inverse_transform( rbf_svr_y_predict ) ) )
