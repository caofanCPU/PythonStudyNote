...
print( 'The accurary of DecisionTree is:',
       dtc.score( v_X_test, y_test ) )
print( classification_report( dtc_y_predict, y_test ) )
# 输出随机森林分类器在测试集上的分类准确性、召回率、F1指标、精确性
print( 'The accurary of RandomForestClassifier is:',
       rfc.score( v_X_test, y_test ) )
print( classification_report( rfc_y_predict, y_test ) )
# 输出梯度提升决策树在测试集上的分类准确性、召回率、F1指标、精确率
print( 'The accurary of GradientTreeBoosing is:',
       gbc.score( v_X_test, y_test ) )
