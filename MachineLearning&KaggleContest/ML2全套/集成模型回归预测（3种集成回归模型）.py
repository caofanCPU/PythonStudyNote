...
print( 'R-squared value of GradientBoostingRegressor is:',
       gbr.score( s_X_test, s_y_test ) )
print( 'MSE value of GradientBoostingRegressor is:',
       mean_squared_error( ss_y.inverse_transform( s_y_test ),
                           ss_y.inverse_transform( gbr_y_predict ) ) )
print( 'MAE value of GradientBoostingRegressor is:',
       mean_absolute_error( ss_y.inverse_transform( s_y_test ),
                            ss_y.inverse_transform( gbr_y_predict ) ) )
