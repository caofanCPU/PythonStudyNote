...
print('-----平均回归方式----')
print('R-squared value of uniform-weights_KNeighborsRegressor is:', uni_knr.score(s_X_test, s_y_test))
print('MSE value of uniform-weights_KNeighborsRegressor is:', mean_squared_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(uni_knr_y_predict)))
print('MSE value of uniform-weights_KNeighborsRegressor is:', mean_absolute_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(uni_knr_y_predict)))

print('----根据距离加权回归-方式---')
print('R-squared value of distance-weights_KNeighborsRegressor is:', dis_knr.score(s_X_test, s_y_test))
print('MSE value of distance-weights_KNeighborsRegressor is:', mean_squared_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(dis_knr_y_predict)))
print('MAE value of distance-weights_KNeighborsRegressor is:', mean_absolute_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(dis_knr_y_predict)))
