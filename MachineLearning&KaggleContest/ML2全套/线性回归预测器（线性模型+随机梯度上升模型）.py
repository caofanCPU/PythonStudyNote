...
print('The value od default measurement of LinearRegression is:', lr.score(s_X_test, s_y_test))
# 使用SGDRegressor模型自带的评估模块，输出评价结果
print('The value od default measurement of SGDRegressor is:', sgdr.score(s_X_test, s_y_test))
# 从sklearn.metrics导入r2_score、mean_squared_error、mean_absolute_erron模块
from sklearn.metrics import r2_score, mean_squared_error, mean_absolute_error

# 使用r2_score模块进行评估
print('The value of R-squared of LinearRegression is:', r2_score(s_y_test, lr_y_predict))
print('The value of R-squared of SGDRegressor is:', r2_score(s_y_test, sgdr_y_predict))
# 使用均方差模块进行评估
print('The mean-squqred-error of LinearRegression is:', mean_squared_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(lr_y_predict)))
print('The mean-squqred-error of SGDRegressor is:', mean_squared_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(sgdr_y_predict)))
# 使用平均绝对误差进行评估
print('The mean-absolute-error of LinearRegression is:', mean_absolute_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(lr_y_predict)))
print('The mean-absolute-error of SGDRegressor is:', mean_absolute_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(sgdr_y_predict)))
