...
print('----回归树模型----')
print('R-squared value of DecisionTreeRegressor is:', dtr.score(s_X_test, s_y_test))
print('MSE value of DecisionTreeRegressor is:', mean_squared_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(dtr_y_predict)))
print('MAE value of DecisionTreeRegressor is:', mean_absolute_error(ss_y.inverse_transform(s_y_test), ss_y.inverse_transform(dtr_y_predict)))
