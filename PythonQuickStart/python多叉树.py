...
# =======
# =======================================================
nodeDic = { 'node_a':Node('A'), 'node_b':Node('B'), 'node_c':Node('C'),
            'node_d':Node('D'), 'node_e':Node('E'), 'node_f':Node('F'),
            'node_g':Node('G'), 'node_h':Node('H'), 'node_i':Node('I'),
            'node_j':Node('J'), 'node_k':Node('K'), 'node_l':Node('L'),
            'node_n':Node('N'),
            'node_o':Node('O'), 'node_p':Node('P'), 'node_q':Node('Q'),
            'node_r':Node('R'), 'node_s':Node('S'), 'node_t':Node('T') }
